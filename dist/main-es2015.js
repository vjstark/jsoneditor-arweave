...
/* harmony import */ var ang_jsoneditor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ang-jsoneditor */ "./node_modules/ang-jsoneditor/__ivy_ngcc__/fesm2015/ang-jsoneditor.js");
...
let ArweaveComponent = class ArweaveComponent {
    constructor() {
        this.publicAddress = "";
        ...
        try {
            ...
            if (file !== undefined && /\.(json)$/i.test(file.name)) {
                ...
                reader.onload = (e) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                    ...
                    const address = yield this.arweave.wallets.jwkToAddress(userKey);
    ...
    createTransaction(data) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let transaction = yield this.arweave.createTransaction({
                data
            }, this.userKey);
            transaction.addTag('appname', 'jsoneditor');
            yield this.arweave.transactions.sign(transaction, this.userKey);
            const response = yield this.arweave.transactions.post(transaction);
            this.editor.data = {};
            this.isSubmitting = false;
            return response;
        });
    ...
    getTransactionIds() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const txids = yield this.arweave.arql({
                op: "and",
                expr1: {
                    op: "equals",
                    expr1: "from",
    ...
    getJsons() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const txids = yield this.getTransactionIds();
            const jsonDatas = yield Promise.all(yield txids.map((txid) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                const transactionData = yield this.getTransaction(txid);
                return transactionData;
            })));
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var ang_jsoneditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ang-jsoneditor */ "./node_modules/ang-jsoneditor/__ivy_ngcc__/fesm2015/ang-jsoneditor.js");
...
let JsonListComponent = class JsonListComponent {
};
